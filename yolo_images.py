...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb  9 14:31:38 2019
...
ap.add_argument("-i", "--image", help="Path to input image file", required=True)
...
# construct a blob (Binary Large OBject) from the input image and then perform a forward
...
# Applying non-maxima suppression suppresses significantly overlapping bounding 
